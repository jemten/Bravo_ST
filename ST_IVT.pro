...
<Velocity11 file='Protocol_Data' md5sum='ba72eb9490243ad84c60c680e4797f3a' version='2.0' >
...
// Get some starting variables 
/*
var tipBox = &quot;TipBox1&quot;;
var tips = [1,2,3,4,5,6,7,8];
var trashPosition = 1;
var oilPosition = 6;
var waterPosition = 5;
*/
...
var protocolName = global.formProtocol || &quot;In vitro transcription&quot;;

// IVT parameters
var sampleRow = global.settings.sampleRow || 6;
var sampleVolume = global.settings.sampleVolume || 16;
var ivtRow = global.settings.ivtRow || 3;
var ivtTemp = global.settings.ivtTemp || 37;
var ivtTime = global.settings.ivtTime || 14 * timeMod * timeMod;
var postIvtRow = global.settings.postIvtRow || 2; 
var dilutionRow = global.settings.dilutionRow || 4;
var dilutionVolume = global.settings.dilutionVolume || 14;

// Testing out status bar
var currentStep = &quot;Preparing for IVT...&quot;;
...
print(&quot;This is global.timeMod, &quot; + global.timeMod);' />
				...
				<Task Name='Bravo::Set temperature - Position' >
					...
					<Parameters >
						...
						<Parameter Category='' Name='Temperature' TaskParameterScript='=ivtTemp;' Value='4' />
		...
		<Main_Processes >
			<Process >
				...
				<Task Name='Bravo::SubProcess' >
					...
					<TaskScript Name='TaskScript' Value='' />
					<Parameters >
						<Parameter Category='' Name='Sub-process name' Value='IVT' />
					...
					<Parameters >
						<Parameter Centrifuge='0' Name='SubProcess_Name' Pipettor='1' Value='IVT' />
					</Parameters>
				</Task>
				<Task Name='Bravo::SubProcess' >
					<Enable_Backup >0</Enable_Backup>
					...
					<TaskScript Name='TaskScript' Value='' />
					<Parameters >
						<Parameter Category='' Name='Sub-process name' Value='Dilute' />
						<Parameter Category='Static labware configuration' Name='Display confirmation' Value='Don&apos;t display' />
						<Parameter Category='Static labware configuration' Name='1' Value='&lt;use default&gt;' />
						<Parameter Category='Static labware configuration' Name='2' Value='&lt;use default&gt;' />
						<Parameter Category='Static labware configuration' Name='3' Value='&lt;use default&gt;' />
					...
					<Parameters >
						<Parameter Centrifuge='0' Name='SubProcess_Name' Pipettor='1' Value='Dilute' />
					</Parameters>
				</Task>
				<Plate_Parameters >
			...
			<Pipette_Process Name='Dilute' >
				...
				<Task Name='Bravo::secondary::Set temperature - Position' Task_Type='1024' >
					...
					<TaskScript Name='TaskScript' Value='global.currentStep = &quot;IVT finished...&quot;;' />
					<Parameters >
						<Parameter Category='' Name='Location' Value='4' />
						<Parameter Category='' Name='Turn off temperature' Value='0' />
						<Parameter Category='' Name='Temperature' Value='4' />
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Dispense' Task_Type='2' >
					...
					<TaskScript Name='TaskScript' Value='task.Wellselection = [[postIvtRow, 1]];
task.Volume = dilutionVolume;
task.Liquidclass = &quot;j_normal_medium_vol&quot;;
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Aspirate' Task_Type='1' >
					...
					<TaskScript Name='TaskScript' Value='task.Wellselection = [[ivtRow,1]];
task.Volume = sampleVolume + 2; 
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Dispense' Task_Type='2' >
					...
					<TaskScript Name='TaskScript' Value='task.Wellselection = [[postIvtRow, 1]];
task.Volume = sampleVolume + 2 + preWetVolume;
task.Liquidclass = &quot;j_normal_medium_vol&quot;;
task.Distancefromwellbottom = 1;' />
					<Parameters >
						<Parameter Category='' Name='Location, plate' Value='EnzymePlate' />
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Mix [Dual Height]' Task_Type='4096' >
					...
					<TaskScript Name='TaskScript' Value='currentVolume = sampleVolume + dilutionVolume +2 + preWetVolume;
...
task.Volume = mix_vol;
task.Wellselection = [[postIvtRow,1]];
...
global.currentStep = &quot;IVT part finished...&quot;;' />
					<Parameters >
...
&lt;/Velocity11&gt;' />
			...
			<Pipette_Process Name='IVT' >
				...
				<Task Name='Bravo::secondary::Set Head Mode' Task_Type='512' >
					...
					<TaskScript Name='TaskScript' Value='task.Headmode = headMode;
global.currentStep = &quot;Mixing sample and IVT mix...&quot;;' />
					<Parameters >
						<Parameter Category='' Name='Head mode' Value='&lt;?xml version=&apos;1.0&apos; encoding=&apos;ASCII&apos; ?&gt;
&lt;Velocity11 file=&apos;MetaData&apos; md5sum=&apos;6eb6437c4beafb3ee091dac7789eba57&apos; version=&apos;1.0&apos; &gt;
	&lt;PipetteHeadMode Channels=&apos;0&apos; ColumnCount=&apos;12&apos; RowCount=&apos;8&apos; SubsetConfig=&apos;1&apos; SubsetType=&apos;0&apos; TipType=&apos;0&apos; /&gt;
...
global.currentStep = &quot;Starting IVT...&quot;;' />
					<Parameters >
						<Parameter Category='' Name='Location, plate' Value='EnzymePlate' />
						<Parameter Category='' Name='Location, location' Value='&lt;auto-select&gt;' />
						<Parameter Category='Volume' Name='Volume' Value='' />
...
global.currentStep = &quot;Covering IVT reaction with oil...&quot;;' />
					<Parameters >
						<Parameter Category='' Name='Location, plate' Value='TipBox1' />
						<Parameter Category='' Name='Location, location' Value='&lt;auto-select&gt;' />
						<Parameter Category='Properties' Name='Allow automatic tracking of tip usage' Value='0' />
...
global.currentStep = &quot;IVT incubation...&quot;;' />
					<Parameters >
						<Parameter Category='' Name='Location, plate' Value='EmptyTipBox' />
						<Parameter Category='' Name='Location, location' Value='&lt;auto-select&gt;' />
						<Parameter Category='Properties' Name='Allow automatic tracking of tip usage' Value='0' />
...
print(&quot;This is the reservation time in seconds: &quot; + (ivtTime - elapsedTime));

var timeToReserve = ivtTime - elapsedTime;
if (timeToReserve &lt; 0){
	print(&quot;it&apos;s happening!&quot;);
	var timeToReserve = 10;
};

task.Reservationtime = timeToReserve;
' />
					<Parameters >
