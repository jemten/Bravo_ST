...
<Velocity11 file='Protocol_Data' md5sum='b55e0584e1cb2ee060ef0c57526bd3d7' version='2.0' >
	<File_Info AllowSimultaneousRun='0' AutoExportGanttChart='0' AutoLoadRacks='When the main protocol starts' AutoUnloadRacks='0' AutomaticallyLoadFormFile='1' Barcodes_Directory='' ClearInventory='0' DeleteHitpickFiles='1' Description='' Device_File='C:\VWorks Workspace\Device Files\BravoMiniPHBenchCel_round_magnet_red4-6.dev' Display_User_Task_Descriptions='1' DynamicAssignPlateStorageLoad='0' FinishScript='' Form_File='' HandlePlatesInInstance='1' ImportInventory='0' InventoryFile='' Notes='' PipettePlatesInInstanceOrder='1' Protocol_Alias='' StartScript='' Use_Global_JS_Context='0' />
	<Processes >
		<Startup_Processes >
			<Process >
...
var pDph = function (vol, endHeight) {
...
var pTipCounter = function (rows, tipsUsed){
	/*
	if (tipsLeft &lt; rows ){
		tipBox = &quot;TipBox2&quot;;
		tipsLeft = 9;
...
var pTipTracker = function (tips, headMode){
...
var pDispRows = function(rows, dispPosition){
...
var tipsInTrash = function (trashTips, headMode){
	var rows = parseInt(headMode.split(&quot;,&quot;)[2], 10);
	var direction = parseInt(headMode.split(&quot;,&quot;)[1], 10);
	if (direction === 1 || direction === 2){
...
// Get global protocol parameters// 
var global = GetGlobalObject();
if(global.runsetMode) global.updateRunset(); 

// General global variables
var protocolName = global.formProtocol || &quot;Row wise SPRI&quot;;
var tipBox = global.strtVariables.tipBox || &quot;TipBox1&quot;;
var tips = global.strtVariables.tips || [1,2,3,4,5,6,7,8];
var trashTips = global.strtVariables.trashTips || [1,2,3,4,5,6,7,8];

// Setting functions
var tipsInTrash = global.tipsInTrash || pTipsInTrash;
var dph = global.dph || pDph;
var tipCounter = global.tipCounter || pTipCounter;
var dispRows = global.dispRows || pDispRows;
var tipTracker = global.tipTracker || pTipTracker;

// Protocol variables
var rows = global.formRows || formRows || 1;
// Operating with front rows
var headMode = &quot;2,3,&quot;+ rows+&quot;,1&quot;;
var timeMod = global.timeMod || 60;  

var beadRow = global.settings.beadRow || 1;
var beadVolume = global.settings.beadVolume || formBeadVolume;

var sampleRow = global.settings.sampleRow || 1;
var sampleVolume = global.settings.sampleVolume || formSampleVolume;

var bindRow = global.settings.bindRow || 1;
var sepRow = global.settings.sepRow || 1;
var eluteInRow = global.settings.eluteInRow || 1;
var elutionMixRow = global.settings.elutionMixRow || 1;
var elutionVolume = global.settings.elutionMixVolume || formElutionMixVolume;

//var ethanolPlate = global.settings.ethanolPlate || &quot;EthanolPlate&quot;;
var ethanolRow = global.settings.ethanolRow || 1;
var ethanolVolume = 200;
var washes = 2;

var bindTime = global.settings.bindTime || formBindTime * timeMod;
var elutionTime = global.settings.elutionTime || formElutionTime * timeMod;
var ethanolDryTime = global.settings.ethanolDrytime || 10 * timeMod;
var pelletTime = global.settings.pelletTime || 1 * timeMod ;
var pelletTimeShort = global.settings.pelletTimeShort || 0.5 * timeMod;
var pelletTimeLong = global.settings.pelletTimeLong || 3 * timeMod;
var nextTemp4 = global.settings.nextTemp4 || 21;
var nextTemp6 = global.settings.nextTemp6 || 21;


// Testing out status bar
var currentStep = &quot;Starting SPRI cleanup...&quot;;

print(&quot;This is the tips object: &quot;+ tips);
print(&quot;This is the tip box: &quot; + tipBox);
print(&quot;This is the trashTips array: &quot; + trashTips);' />
					<Parameters >
				...
				<Task Name='Bravo::Set temperature - Position' >
					...
					<TaskScript Name='TaskScript' Value='task.Location = 4;
task.Temperature = enzymeTemp;
task.Wait = false;
...
' />
		...
		<Main_Processes >
			<Process >
				...
				<Plate_Parameters >
					<Parameter Name='Plate name' Value='TipBox1' />
			...
			<Process >
				...
				<Plate_Parameters >
					<Parameter Name='Plate name' Value='EnzymePlate' />
					<Parameter Name='Plate type' Value='96 Eppendorf Twin.tec PCR' />
					<Parameter Name='Simultaneous plates' Value='1' />
					<Parameter Name='Plates have lids' Value='0' />
					<Parameter Name='Plates enter the system sealed' Value='0' />
			...
			<Process >
				...
				<Task Name='Bravo::SubProcess' >
					...
					<Parameters >
						<Parameter Centrifuge='0' Name='SubProcess_Name' Pipettor='1' Value='movingTips' />
					</Parameters>
				</Task>
				<Plate_Parameters >
...
var mBlowoutHeight = 12;
var mDoTipTouch = true;
var mTouchRetract = -7;
global.currentStep = &quot;Percipitating sample onto beads...&quot;;' />
					<Parameters >
						<Parameter Category='Task Description' Name='Task number' Value='2' />
						<Parameter Category='Task Description' Name='Task description' Value='JavaScript' />
						<Parameter Category='Task Description' Name='Use default task description' Value='1' />
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Tips On' Task_Type='16' >
					...
					<Parameters >
						<Parameter Category='' Name='Location, plate' Value='TipBox1' />
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Shake' Task_Type='1024' >
					...
					<TaskScript Name='TaskScript' Value='if ((sampleVolume + beadVolume) &gt; 150){
	task.skip;
}
' />
					<Parameters >
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Shake' Task_Type='1024' >
					...
					<TaskScript Name='TaskScript' Value='if ((beadVolume + sampleVolume) &gt; 150 ){
	task.skip;
}
' />
					<Parameters >
...
&lt;/Velocity11&gt;' />
				...
				<Dependencies >
					<Sub_Process Name='transferBeads' />
					<Sub_Process Name='transferSample' />
				</Dependencies>
			</Pipette_Process>
			<Pipette_Process Name='elute' >
				...
				<Task Name='BuiltIn::JavaScript' >
					...
					<TaskScript Name='TaskScript' Value='var mHeadMode = headMode;
var mAspPosition = [[elutionMixRow,1]];
var mDispPosition = [[eluteInRow,1]];
var mSepPosition = [[sepRow,1]];
...
global.currentStep = &quot;Eluting sample...&quot;;' />
					<Parameters >
						<Parameter Category='Task Description' Name='Task number' Value='2' />
						<Parameter Category='Task Description' Name='Task description' Value='JavaScript' />
						<Parameter Category='Task Description' Name='Use default task description' Value='1' />
...
task.Wellselection = mAspPosition;
task.Volume = mPreAspVolume;
task.Liquidclass = &quot;j_normal_large_vol&quot;;
task.Distancefromwellbottom = 50;' />
					<Parameters >
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Aspirate' Task_Type='1' >
					...
					<TaskScript Name='TaskScript' Value='task.Wellselection = mAspPosition;
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Dispense' Task_Type='2' >
					...
					<TaskScript Name='TaskScript' Value='task.Wellselection = mSepPosition;
task.Volume = mTransferVolume / mNumberSteps;
task.Liquidclass = mLiquidClass;
...
var mTimerCycles = 5;
var mMixVolume = elutionVolume * 0.6;
...
task.Mixcycles = mTimerCycles;
task.Aspiratedistance = mAspDistance;
task.Wellselection = mSepPosition;
if(mAspDistance !== mDispDistance) {
    task.Dispenseatdifferentdistance = true;
    task.Dispensedistance = mDispDistance;
} else {
...
var mPreAspVolume = PRE_ASP_MEDIUM;
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Aspirate' Task_Type='1' >
					...
					<TaskScript Name='TaskScript' Value='task.Wellselection =[[sepRow,1]];
task.Volume = mTransferVolume / mNumberSteps;
task.Liquidclass = mLiquidClass;
task.Distancefromwellbottom = mAspDistance;' />
					<Parameters >
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Dispense' Task_Type='2' >
					...
					<TaskScript Name='TaskScript' Value='task.Wellselection = [[eluteInRow,1]];
task.Volume = mTransferVolume / mNumberSteps;
task.Liquidclass = mLiquidClass;
task.Distancefromwellbottom = mDispDistance;' />
					<Parameters >
						<Parameter Category='' Name='Location, plate' Value='EnzymePlate' />
						<Parameter Category='' Name='Location, location' Value='&lt;auto-select&gt;' />
						<Parameter Category='Volume' Name='Empty tips' Value='0' />
						<Parameter Category='Volume' Name='Volume' Value='' />
						<Parameter Category='Volume' Name='Blowout volume' Value='' />
...
task.Wellselection = [[eluteInRow,1]];
task.Volume = mPreAspVolume;
task.Liquidclass = &quot;j_blowout&quot;;
task.Distancefromwellbottom = mBlowoutHeight;
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Tips Off' Task_Type='32' >
					...
					<TaskScript Name='TaskScript' Value='task.Wellselection = [[8,1]];
/*
tempo = tipsInTrash(trashTips, headMode);
trashTips = tempo.trashTips;
trashTipRow = tempo.trashTipRow;

task.Wellselection = [[trashTipRow,1]];
*/
global.currentStep = &quot;SPRI cleanup finished...&quot;;
' />
					<Parameters >
...
&lt;/Velocity11&gt;' />
				...
				<Dependencies >
					<Sub_Process Name='bind' />
					<Sub_Process Name='removeBindMix' />
					<Sub_Process Name='rinseTips' />
					<Sub_Process Name='transferBeads' />
					<Sub_Process Name='transferSample' />
					<Sub_Process Name='wash' />
				</Dependencies>
			</Pipette_Process>
			<Pipette_Process Name='movingTips' >
				<Minimized >0</Minimized>
				<Task Name='BuiltIn::Group Begin' >
					<Enable_Backup >0</Enable_Backup>
					<Task_Disabled >0</Task_Disabled>
				...
				<Task Name='Bravo::secondary::Set Head Mode' Task_Type='512' >
					...
					<TaskScript Name='TaskScript' Value='// Changing from front rows to back rows.
task.Headmode = &quot;2,2,&quot;+ rows+&quot;,1&quot;;
' />
					<Parameters >
						<Parameter Category='' Name='Head mode' Value='&lt;?xml version=&apos;1.0&apos; encoding=&apos;ASCII&apos; ?&gt;
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Tips On' Task_Type='16' >
					...
					<TaskScript Name='TaskScript' Value='var tipsToTake = 8-rows+1;
task.Wellselection = [[tipsToTake,1]];' />
					<Parameters >
						<Parameter Category='' Name='Location, plate' Value='EmptyTipBox' />
						<Parameter Category='' Name='Location, location' Value='&lt;auto-select&gt;' />
						<Parameter Category='Properties' Name='Allow automatic tracking of tip usage' Value='0' />
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Tips Off' Task_Type='32' >
					...
					<TaskScript Name='TaskScript' Value='tempo = tipsInTrash(trashTips, headMode);
trashTips = tempo.trashTips;
trashTipRow = tempo.trashTipRow;
task.Wellselection = [[trashTipRow,1]];
' />
...
&lt;/Velocity11&gt;' />
			...
			<Pipette_Process Name='removeBindMix' >
				...
				<Task Name='BuiltIn::Reserve Location' >
					...
					<Has_Breakpoint >0</Has_Breakpoint>
					<Advanced_Settings />
					<TaskScript Name='TaskScript' Value='var timeToWait = pelletTimeLong/2; 
task.Reservationtime = timeToWait;' />
					<Parameters >
						<Parameter Category='Task Description' Name='Task number' Value='1' />
						<Parameter Category='Task Description' Name='Task description' Value='Reserve Location' />
						<Parameter Category='Task Description' Name='Use default task description' Value='1' />
				...
				<Task Name='BuiltIn::JavaScript' >
					...
					<TaskScript Name='TaskScript' Value='var mHeadMode = headMode;
var mAspPosition = [[sepRow,1]];
var mDispPosition = [[8,1]];
var mGetTips = false;
...
var mDispDistance = 35;
var mBlowoutHeight = 30;
var mDoTipTouch = true;
var mTouchRetract = 0;

global.currentStep = &quot;Separating beads...&quot;;
' />
					<Parameters >
						<Parameter Category='Task Description' Name='Task number' Value='3' />
						<Parameter Category='Task Description' Name='Task description' Value='JavaScript' />
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Mix [Dual Height]' Task_Type='4096' >
					...
					<TaskScript Name='TaskScript' Value='task.Wellselection = mAspPosition;
task.Volume = bindMixVolume;
task.Liquidclass = mLiquidClass;
task.Mixcycles = 3;
task.Aspiratedistance = 1.25;
task.Dispensedistance = 1.25;' />
					<Parameters >
						<Parameter Category='' Name='Location, plate' Value='ReactionPlate' />
						<Parameter Category='' Name='Location, location' Value='&lt;auto-select&gt;' />
						<Parameter Category='Volume' Name='Volume' Value='' />
...
task.Wellselection = mAspPosition;
task.Distancefromwellbottom = 12;
task.Liquidclass = &quot;j_blowout&quot;;
task.Performtiptouch = true;
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Dispense' Task_Type='2' >
					...
					<TaskScript Name='TaskScript' Value='task.Wellselection = mDispPosition;
task.Volume = mTransferVolume / mNumberSteps;
task.Liquidclass = mLiquidClass;
task.Distancefromwellbottom = mDispDistance;
task.Performtiptouch = true;
task.Whichsidestousefortiptouch = &quot;South/North&quot;;' />
					<Parameters >
						<Parameter Category='' Name='Location, plate' Value='WastePlate' />
						<Parameter Category='' Name='Location, location' Value='&lt;auto-select&gt;' />
						<Parameter Category='Volume' Name='Empty tips' Value='0' />
						<Parameter Category='Volume' Name='Volume' Value='' />
						<Parameter Category='Volume' Name='Blowout volume' Value='' />
...
task.Wellselection = mDispPosition;
task.Volume = mPreAspVolume;
task.Liquidclass = &quot;j_blowout&quot;;
task.Distancefromwellbottom = mBlowoutHeight;
task.Performtiptouch = mDoTipTouch;
...
global.currentStep = &quot;Rinsing tips...&quot;;' />
					<Parameters >
						<Parameter Category='Task Description' Name='Task number' Value='2' />
						<Parameter Category='Task Description' Name='Task description' Value='JavaScript' />
						<Parameter Category='Task Description' Name='Use default task description' Value='1' />
...
&lt;/Velocity11&gt;' />
			...
			<Pipette_Process Name='transferBeads' >
				...
				<Task Name='BuiltIn::JavaScript' >
					...
					<TaskScript Name='TaskScript' Value='
var mHeadMode = &quot;2,3,1,1&quot;; //The beads will always only be in one column
var mAspPosition = [[beadRow,1]];
var mDispPosition = [[bindRow,1]];
...
var mTransferVolume = beadVolume * rows;
var mAspDistance = 1;
var mDispDistance = 1;
...
global.currentStep = &quot;Mixing beads...&quot;;' />
					<Parameters >
						<Parameter Category='Task Description' Name='Task number' Value='2' />
						<Parameter Category='Task Description' Name='Task description' Value='JavaScript' />
						<Parameter Category='Task Description' Name='Use default task description' Value='1' />
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Tips On' Task_Type='16' >
					...
					<TaskScript Name='TaskScript' Value='if ((tips.length - 1) &lt; 0){
	throw &quot;Not enough Tips left in Box&quot;;
}else{
	tempo = tipTracker(tips, mHeadMode);
	if (rows === 1){
		// Only update tips array if the tips are not to be returned
		tips = tempo.tips;
	}
	tipRow = tempo.tipRow;
	task.Wellselection = [[tempo.tipRow, 1]];
}
' />
					<Parameters >
						<Parameter Category='' Name='Location, plate' Value='TipBox1' />
...
global.currentStep = &quot;Transferring beads...&quot;;' />
					<Parameters >
						<Parameter Category='Task Description' Name='Task number' Value='8' />
						<Parameter Category='Task Description' Name='Task description' Value='JavaScript' />
						<Parameter Category='Task Description' Name='Use default task description' Value='1' />
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Dispense' Task_Type='2' >
					...
					<TaskScript Name='TaskScript' Value='task.Wellselection = dispRows(rows, mDispPosition);
task.Volume = mTransferVolume / mNumberSteps;
task.Liquidclass = mLiquidClass;
task.Distancefromwellbottom = mDispDistance;
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Tips Off' Task_Type='32' >
					...
					<TaskScript Name='TaskScript' Value='if(rows === 1) {
   task.skip();
} else {
   task.Wellselection[[tempo.tipRow, 1]];
}
...
/* 
When rows = 2:
Return the tips that have been used for the bead 
dispersion to theiroriginal position and pick up the 
same tips plus one row extra. Saves a row of tips
that would be wasted otherwise. Alternatively, 
reserve a row of tip that are used for all the bead 
dispersions (Maybe not good since it blocks the tipbox)
When rows = 1: 
Skip task.
*/' />
					<Parameters >
...
var mAspPosition = [[sampleRow,1]];
var mDispPosition = [[bindRow,1]];

global.currentStep = &quot;Transferring sample to beads...&quot;;' />
					<Parameters >
						<Parameter Category='Task Description' Name='Task number' Value='2' />
						<Parameter Category='Task Description' Name='Task description' Value='JavaScript' />
						<Parameter Category='Task Description' Name='Use default task description' Value='1' />
...
&lt;/Velocity11&gt;' />
	...
	tempo = TipTracker(tips, headMode);
	tips = tempo.tips;
	task.Wellselection = [[tempo.tipRow, 1]];
}
' />
...
task.Volume = bindMixVolume;
task.Mixcycles = 2;
task.Liquidclass = &quot;j_extra_slow_mixing&quot;; 
task.Dispenseatdifferentdistance = true;
...
&lt;/Velocity11&gt;' />
			...
			<Pipette_Process Name='wash' >
				...
				<Task Name='Bravo::secondary::Set temperature - Position' Task_Type='1024' >
					...
					<TaskScript Name='TaskScript' Value='task.Temperature = nextTemp6;' />
					<Parameters >
						<Parameter Category='' Name='Location' Value='6' />
						<Parameter Category='' Name='Turn off temperature' Value='0' />
						<Parameter Category='' Name='Temperature' Value='' />
				...
				<Task Name='Bravo::secondary::Set temperature - Position' Task_Type='1024' >
					...
					<TaskScript Name='TaskScript' Value='task.Temperature = nextTemp4;
' />
					<Parameters >
						<Parameter Category='' Name='Location' Value='4' />
						<Parameter Category='' Name='Turn off temperature' Value='0' />
...
global.currentStep = &quot;Washing beads...&quot;;' />
					<Parameters >
						<Parameter Category='' Name='Head mode' Value='&lt;?xml version=&apos;1.0&apos; encoding=&apos;ASCII&apos; ?&gt;
&lt;Velocity11 file=&apos;MetaData&apos; md5sum=&apos;5929d18748dd2bd11633d3faafa655d1&apos; version=&apos;1.0&apos; &gt;
	&lt;PipetteHeadMode Channels=&apos;0&apos; ColumnCount=&apos;12&apos; RowCount=&apos;8&apos; SubsetConfig=&apos;0&apos; SubsetType=&apos;0&apos; TipType=&apos;0&apos; /&gt;
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Aspirate' Task_Type='1' >
					...
					<TaskScript Name='TaskScript' Value='task.Wellselection = [[ethanolRow, 1]];
' />
					<Parameters >
						<Parameter Category='' Name='Location, plate' Value='BeadPlate' />
						<Parameter Category='' Name='Location, location' Value='&lt;auto-select&gt;' />
						<Parameter Category='Volume' Name='Volume' TaskParameterScript='=PRE_ASP_MEDIUM;' Value='' />
						<Parameter Category='Volume' Name='Pre-aspirate volume' Value='0' />
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='BuiltIn::JavaScript' >
					...
					<TaskScript Name='TaskScript' Value='var steps = Math.ceil(ethanolVolume / MAX_VOLUME);
' />
					<Parameters >
						<Parameter Category='Task Description' Name='Task number' Value='8' />
						<Parameter Category='Task Description' Name='Task description' Value='JavaScript' />
				...
				<Task Name='Bravo::secondary::Aspirate' Task_Type='1' >
					...
					<TaskScript Name='TaskScript' Value='task.Volume = ethanolVolume / steps;
task.Wellselection = [[ethanolRow,1]];' />
					<Parameters >
						<Parameter Category='' Name='Location, plate' Value='BeadPlate' />
						<Parameter Category='' Name='Location, location' Value='&lt;auto-select&gt;' />
						<Parameter Category='Volume' Name='Volume' Value='' />
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Mix [Dual Height]' Task_Type='4096' >
					...
					<TaskScript Name='TaskScript' Value='task.Volume = (ethanolVolume * 0.8 &gt; MAX_MIX_VOLUME) ? MAX_MIX_VOLUME : ethanolVolume * 0.8;
task.Wellselection = [[sepRow,1]]' />
					<Parameters >
						<Parameter Category='' Name='Location, plate' Value='ReactionPlate' />
						<Parameter Category='' Name='Location, location' Value='&lt;auto-select&gt;' />
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='BuiltIn::JavaScript' >
					...
					<TaskScript Name='TaskScript' Value='steps = Math.ceil((ethanolVolume + 10) / MAX_VOLUME);' />
					<Parameters >
						<Parameter Category='Task Description' Name='Task number' Value='15' />
						<Parameter Category='Task Description' Name='Task description' Value='JavaScript' />
						<Parameter Category='Task Description' Name='Use default task description' Value='1' />
				...
				<Task Name='Bravo::secondary::Aspirate' Task_Type='1' >
					...
					<TaskScript Name='TaskScript' Value='task.Volume = (ethanolVolume + 10) / steps;
task.Wellselection = [[sepRow,1]];' />
					<Parameters >
						<Parameter Category='' Name='Location, plate' Value='ReactionPlate' />
						<Parameter Category='' Name='Location, location' Value='&lt;auto-select&gt;' />
		...
		<Cleanup_Processes >
			<Process >
				...
				<Task Name='BuiltIn::JavaScript' >
					...
					<TaskScript Name='TaskScript' Value='if (typeof global !== &quot;undefined&quot;){
	global.strtVariables.tipBox = tipBox;  
	global.strtVariables.trashTips = trashTips;
	global.strtVariables.tips = tips;
}
