...
<Velocity11 file='Protocol_Data' md5sum='1475dde9bc50ec8fe5cdfac629b648e9' version='2.0' >
...
/* Reads in the settings namespace that is
specific for this part of the protocol*/
...
//var trashPosition = global.strtVariables.trashPosition || 1;
var trashTips = global.strtVariables.trashTips || [1,2,3,4,5,6,7,8]; 
var oilPosition = global.strtVariables.oilPosition || 6;
var waterPosition =  global.strtVariables.waterPosition ||5;

// If running standalone:
var pTipsInTrash = function (trashTips, headMode){
...
// For changing between testing and running; shortens incubation times to seconds
// in normal mode the timeMod is 60

var rows = global.formRows || 1;
var headMode = &quot;2,2,&quot;+ rows+&quot;,1&quot;;
var protocolName = global.formProtocol || &quot;Second strand synthesis&quot;;

// Seconds strand synthesis parameters

var sampleRow = global.settings.sampleRow || 1;
var sampleVolume = global.settings.sampleVolume || 65;
var secondSSRow = global.settings.secondSSRow || 2;
var secondSSMixVolume = global.settings.secondSSMixVolume || 5;
var secondSSReactionRow = global.settings.secondSSReactionRow || 1;
var secondSSIncubationTime = global.settings.secondSSIncubationTime || 120 * timeMod;
var secondSSIncubationTemp = global.settings.secondStrandIncubationTemp || 16;

// Infill Parameters
var infillMixRow = global.settings.infillMixRow || 3;
var infillMixVolume = global.settings.infillMixVolume || 5;
var infillReactionRow = global.settings.infillReactionRow || 2;
var infillIncubationTime = global.settings.infillReactionTime || 20 * timeMod; 
var infillIncubationTemp = global.settings.infillIncubationTemp || 16;

// EDTA parameters
var stopMixRow = global.settings.stopMixRow || 4;
var stopMixVolume = global.settings.stopMixVolume || 25;

// Testing out status bar
global.currentStep = &quot;Presets loaded...&quot;;

print(&quot;This is timeMod, &quot; + timeMod);
print(&quot;This is global.formTimeMod, &quot; + global.formTimeMod);
print(&quot;This is global.timeMod, &quot; + global.timeMod);' />
					<Parameters >
				...
				<Task Name='Bravo::Set temperature - Position' >
					...
					<Parameters >
						...
						<Parameter Category='' Name='Temperature' TaskParameterScript='=secondSSIncubationTemp;' Value='4' />
				...
				<Task Name='Bravo::Set temperature - Position' >
					...
					<TaskScript Name='TaskScript' Value='global.currentStep = &quot;Waiting for enzyme block to cool...&quot;;' />
					<Parameters >
				...
				<Task Name='BuiltIn::User Message' >
					...
					<Parameters >
						...
						<Parameter Category='' Name='Body' Value='Place enzyme plate on position 4' />
		...
		<Main_Processes >
			<Process >
				...
				<Task Name='Bravo::SubProcess' >
					...
					<TaskScript Name='TaskScript' Value='' />
					<Parameters >
						<Parameter Category='' Name='Sub-process name' Value='secondStrandSynthesis' />
					...
					<Parameters >
						<Parameter Centrifuge='0' Name='SubProcess_Name' Pipettor='1' Value='secondStrandSynthesis' />
					</Parameters>
				</Task>
				<Task Name='Bravo::SubProcess' >
					<Enable_Backup >0</Enable_Backup>
					...
					<TaskScript Name='TaskScript' Value='' />
					<Parameters >
						<Parameter Category='' Name='Sub-process name' Value='infill' />
						<Parameter Category='Static labware configuration' Name='Display confirmation' Value='Don&apos;t display' />
						<Parameter Category='Static labware configuration' Name='1' Value='&lt;use default&gt;' />
						<Parameter Category='Static labware configuration' Name='2' Value='&lt;use default&gt;' />
						<Parameter Category='Static labware configuration' Name='3' Value='&lt;use default&gt;' />
					...
					<Parameters >
						<Parameter Centrifuge='0' Name='SubProcess_Name' Pipettor='1' Value='infill' />
					</Parameters>
				</Task>
				<Plate_Parameters >
			...
			<Pipette_Process Name='infill' >
				...
				<Task Name='BuiltIn::JavaScript' >
					...
					<TaskScript Name='TaskScript' Value='global.secondStrandSynthesis = 1;
' />
					<Parameters >
						<Parameter Category='Task Description' Name='Task number' Value='2' />
						<Parameter Category='Task Description' Name='Task description' Value='JavaScript' />
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Tips On' Task_Type='16' >
					...
					<TaskScript Name='TaskScript' Value='if ((tips.length - rows) &lt; 0){
	throw &quot;Not enough Tips left in Box&quot;;
}else{
	tempo = tipTracker(tips, headMode); 
	tips = tempo.tips;
	tipRow = tempo.tipRow;
	task.Wellselection = [[tipRow,1]];
	//task.Wellselection = [[tipsLeft-rows,1]];
	//var tipsLeft = tipsLeft - rows;
}
global.currentStep = &quot;Getting sample under oil...&quot;;' />
					<Parameters >
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Aspirate' Task_Type='1' >
					...
					<TaskScript Name='TaskScript' Value='task.Wellselection = [[waterPosition,1]]; 
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Aspirate' Task_Type='1' >
					...
					<TaskScript Name='TaskScript' Value='task.Wellselection = [[secondSSReactionRow,1]];
task.Volume = currentVolume+2; ' />
					<Parameters >
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Dispense' Task_Type='2' >
					...
					<TaskScript Name='TaskScript' Value='task.Wellselection = [[infillMixRow, 1]];
task.Volume = currentVolume;
' />
					<Parameters >
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Mix [Dual Height]' Task_Type='4096' >
					...
					<TaskScript Name='TaskScript' Value='currentVolume = currentVolume + infillMixVolume;

var mix_vol = 0.8 * (currentVolume);
if(mix_vol &gt; MAX_MIX_VOLUME) {
	mix_vol = MAX_MIX_VOLUME;
}
task.Volume = mix_vol;
task.Wellselection = [[infillMixRow,1]];
global.currentStep = &quot;Preparing for infill reaction...&quot;;' />
					<Parameters >
						<Parameter Category='' Name='Location, plate' Value='EnzymePlate' />
						<Parameter Category='' Name='Location, location' Value='&lt;auto-select&gt;' />
						<Parameter Category='Volume' Name='Volume' Value='' />
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Dispense' Task_Type='2' >
					...
					<TaskScript Name='TaskScript' Value='task.Wellselection = [[infillReactionRow,1]];
task.Volume = currentVolume+2;
' />
					<Parameters >
						<Parameter Category='' Name='Location, plate' Value='ReactionPlate' />
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='BuiltIn::Reserve Location' >
					...
					<Has_Breakpoint >0</Has_Breakpoint>
					<Advanced_Settings />
					<TaskScript Name='TaskScript' Value='global.currentStep = &quot;Infill incubation...&quot;;
task.Reservationtime =  infillIncubationTime;
' />
					<Parameters >
				...
				<Task Name='Bravo::secondary::Aspirate' Task_Type='1' >
					...
					<TaskScript Name='TaskScript' Value='task.Volume = PRE_ASP_MEDIUM;
task.Wellselection= [[infillReactionRow,1]];
global.currentStep = &quot;Mixing sample and EDTA...&quot;;' />
					<Parameters >
						<Parameter Category='' Name='Location, plate' Value='ReactionPlate' />
						<Parameter Category='' Name='Location, location' Value='&lt;auto-select&gt;' />
						<Parameter Category='Volume' Name='Volume' Value='' />
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Dispense' Task_Type='2' >
					...
					<TaskScript Name='TaskScript' Value='task.Wellselection = [[stopMixRow,1]];
task.Volume = currentVolume+2;
currentVolume = currentVolume + stopMixVolume + 2;
' />
					<Parameters >
						<Parameter Category='' Name='Location, plate' Value='EnzymePlate' />
						<Parameter Category='' Name='Location, location' Value='&lt;auto-select&gt;' />
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Mix [Dual Height]' Task_Type='4096' >
					...
					<TaskScript Name='TaskScript' Value='var mix_vol = 0.8 * (currentVolume);
if(mix_vol &gt; MAX_MIX_VOLUME) {
	mix_vol = MAX_MIX_VOLUME;
}
task.Volume = mix_vol;
task.Wellselection = [[stopMixRow,1]];
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Dispense' Task_Type='2' >
					...
					<TaskScript Name='TaskScript' Value='task.Wellselection = [[stopMixRow,1]];
task.Volume = PRE_ASP_MEDIUM;
task.Liquidclass = &quot;j_normal_small_vol&quot;;
task.Distancefromwellbottom = 10;
...
global.currentStep = &quot;Rearranging the deck for SPRI cleanup...&quot;;

//task.Wellselection = [[trashPosition,1]];
//trashPosition = tipsInTrash(rows, trashPosition).nextRow;
' />
					<Parameters >
...
&lt;/Velocity11&gt;' />
			...
			<Pipette_Process Name='secondStrandSynthesis' >
				<Minimized >0</Minimized>
				<Task Name='BuiltIn::Group Begin' >
					<Enable_Backup >0</Enable_Backup>
					<Task_Disabled >0</Task_Disabled>
...
&lt;/Velocity11&gt;' />
	...
	// one thing at a time needs to figure out how this function works
	//task.Location_plate = tipBox
	tempo = tipTracker(tips, headMode); 
	tips = tempo.tips;
	tipRow = tempo.tipRow;
	task.Wellselection = [[tipRow,1]];
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Aspirate' Task_Type='1' >
					...
					<TaskScript Name='TaskScript' Value='task.Wellselection = [[sampleRow,1]]; 
task.Distancefromwellbottom = 30;
task.Liquidclass = &quot;j_normal_large_vol&quot;;
task.Volume = PRE_ASP_SMALL;
global.currentStep = &quot;Mixing sample with second strand enzyme mix...&quot;;' />
					<Parameters >
						<Parameter Category='' Name='Location, plate' Value='EnzymePlate' />
						<Parameter Category='' Name='Location, location' Value='&lt;auto-select&gt;' />
						<Parameter Category='Volume' Name='Volume' Value='' />
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Dispense' Task_Type='2' >
					...
					<TaskScript Name='TaskScript' Value='task.Wellselection = [[secondSSRow,1]];
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Mix [Dual Height]' Task_Type='4096' >
					...
					<TaskScript Name='TaskScript' Value='var mix_vol = 0.8 * (sampleVolume + secondSSMixVolume);
if(mix_vol &gt; MAX_MIX_VOLUME) {
	mix_vol = MAX_MIX_VOLUME;
}
task.Wellselection = [[secondSSRow,1]];
task.Volume = mix_vol;
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Aspirate' Task_Type='1' >
					...
					<TaskScript Name='TaskScript' Value='currentVolume = sampleVolume + secondSSMixVolume+2;
task.Wellselection = [[secondSSRow, 1]];
task.Volume = currentVolume;
global.currentStep = &quot;Starting second strand synthsesis...&quot;;' />
					<Parameters >
						<Parameter Category='' Name='Location, plate' Value='EnzymePlate' />
						<Parameter Category='' Name='Location, location' Value='&lt;auto-select&gt;' />
						<Parameter Category='Volume' Name='Volume' Value='' />
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='BuiltIn::JavaScript' >
					...
					<TaskScript Name='TaskScript' Value='var incubationStartTime = new Date().getTime();
' />
					<Parameters >
						<Parameter Category='Task Description' Name='Task number' Value='11' />
						<Parameter Category='Task Description' Name='Task description' Value='JavaScript' />
...
global.currentStep = &quot;Adding oil cover...&quot;;' />
					<Parameters >
						<Parameter Category='' Name='Location, plate' Value='TipBox1' />
						<Parameter Category='' Name='Location, location' Value='&lt;auto-select&gt;' />
						<Parameter Category='Properties' Name='Allow automatic tracking of tip usage' Value='0' />
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Aspirate' Task_Type='1' >
					...
					<TaskScript Name='TaskScript' Value='task.Wellselection = [[oilPosition, 1]];
task.Volume = PRE_ASP_MEDIUM;
task.Liquidclass = &quot;j_normal_small_vol&quot;;
task.Distancefromwellbottom = 50; ' />
					<Parameters >
...
&lt;Velocity11 file=&apos;MetaData&apos; md5sum=&apos;14fa6a07f8447c0231d064af9c10f313&apos; version=&apos;1.0&apos; &gt;
	...
	&lt;/WellSelection&gt;
&lt;/Velocity11&gt;' />
						<Parameter Category='Properties' Name='Pipette technique' Value='offset 65% - Front' />
						<Parameter Category='Task Description' Name='Task number' Value='16' />
						<Parameter Category='Task Description' Name='Task description' Value='Dispense (Bravo)' />
						<Parameter Category='Task Description' Name='Use default task description' Value='1' />
					</Parameters>
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='BuiltIn::Reserve Location' >
					...
					<Has_Breakpoint >0</Has_Breakpoint>
					<Advanced_Settings />
					<TaskScript Name='TaskScript' Value='var currentTime = new Date().getTime();
var elapsedTime = Math.round((currentTime - incubationStartTime)/1000);
global.currentStep = &quot;Second strand synthesis incubation...&quot;;
task.Reservationtime =secondSSIncubationTime - elapsedTime;
' />
					<Parameters >
						<Parameter Category='Task Description' Name='Task number' Value='20' />
						<Parameter Category='Task Description' Name='Task description' Value='Reserve Location' />
		...
		<Cleanup_Processes >
			<Process >
				...
				<Task Name='BuiltIn::JavaScript' >
					...
					<TaskScript Name='TaskScript' Value='// updates the global variables 

global.strtVariables.tipBox = tipBox;  
//global.strtVariables.trashPosition = trashPosition;
global.strtVariables.tips = tips;
global.strtVariables.trashTips = trashTips;

print(&quot;This is the tips object: &quot;+ tips);
//print(&quot;This is the trash position:&quot; + trashPosition);
