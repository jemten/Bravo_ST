...
<Velocity11 file='Protocol_Data' md5sum='8f7a27f75f16dde696b88aed42254f2e' version='2.0' >
...
global.currentStep = &quot;Rearranging the deck...&quot;' />
					<Parameters >
		...
		<Main_Processes >
			...
			<Process >
				...
				<Task Name='BuiltIn::Spawn Process' >
					...
					<Has_Breakpoint >0</Has_Breakpoint>
					<Advanced_Settings />
					<TaskScript Name='TaskScript' Value='// Dummy to not trigger any errors' />
					<Parameters >
						<Parameter Category='' Name='Process to spawn' Value='EmptyTipBox' />
