...
<Velocity11 file='Protocol_Data' md5sum='32c118975199cab2a4cb7f8c22ab317f' version='2.0' >
...
var timeMod = global.timeMod; // || formTimeMod;  
...
global.currentStep = &quot;Starting SPRI cleanup...&quot;;
...
print(&quot;This is global.formRows, &quot; + global.formRows); 
		...
		<Main_Processes >
			...
			<Process >
				...
				<Task Name='Bravo::SubProcess' >
					...
					<TaskScript Name='TaskScript' Value='' />
					<Parameters >
						<Parameter Category='' Name='Sub-process name' Value='movingTips' />
						<Parameter Category='Static labware configuration' Name='Display confirmation' Value='Don&apos;t display' />
						<Parameter Category='Static labware configuration' Name='1' Value='&lt;use default&gt;' />
						<Parameter Category='Static labware configuration' Name='2' Value='&lt;use default&gt;' />
						<Parameter Category='Static labware configuration' Name='3' Value='&lt;use default&gt;' />
			...
			<Pipette_Process Name='bind' >
				...
				<Task Name='BuiltIn::JavaScript' >
					...
					<TaskScript Name='TaskScript' Value='var mWellSelection = [[rows,1]];
...
global.currentStep = &quot;Percipitating sample to beads...&quot;;' />
					<Parameters >
						<Parameter Category='Task Description' Name='Task number' Value='2' />
						<Parameter Category='Task Description' Name='Task description' Value='JavaScript' />
						<Parameter Category='Task Description' Name='Use default task description' Value='1' />
...
&lt;/Velocity11&gt;' />
					...
					<PipetteHead AssayMap='0' Disposable='1' HasTips='1' MaxRange='251' MinRange='-41' Name='96LT, 200 킠 Series III' >
						<PipetteHeadMode Channels='0' ColumnCount='12' RowCount='1' SubsetConfig='3' SubsetType='2' TipType='0' />
					</PipetteHead>
				</Task>
...
' />
					<Parameters >
						...
						<Parameter Category='Properties' Name='Well selection' Value='&lt;?xml version=&apos;1.0&apos; encoding=&apos;ASCII&apos; ?&gt;
&lt;Velocity11 file=&apos;MetaData&apos; md5sum=&apos;3e4a07789d05d660950dc861990ceff5&apos; version=&apos;1.0&apos; &gt;
	&lt;WellSelection CanBe16QuadrantPattern=&apos;0&apos; CanBeLinked=&apos;0&apos; CanBeQuadrantPattern=&apos;0&apos; IsLinked=&apos;0&apos; IsQuadrantPattern=&apos;0&apos; OnlyOneSelection=&apos;1&apos; OverwriteHeadMode=&apos;0&apos; QuadrantPattern=&apos;0&apos; StartingQuadrant=&apos;1&apos; &gt;
		&lt;PipetteHeadMode Channels=&apos;0&apos; ColumnCount=&apos;12&apos; RowCount=&apos;1&apos; SubsetConfig=&apos;3&apos; SubsetType=&apos;2&apos; TipType=&apos;0&apos; /&gt;
		&lt;Wells &gt;
			&lt;Well Column=&apos;0&apos; Row=&apos;7&apos; /&gt;
...
' />
					<Parameters >
						...
						<Parameter Category='Properties' Name='Mark tips as used' Value='0' />
						<Parameter Category='Properties' Name='Well selection' Value='&lt;?xml version=&apos;1.0&apos; encoding=&apos;ASCII&apos; ?&gt;
&lt;Velocity11 file=&apos;MetaData&apos; md5sum=&apos;77baef7e6c9f6274b650d142e7edf4f4&apos; version=&apos;1.0&apos; &gt;
	&lt;WellSelection CanBe16QuadrantPattern=&apos;0&apos; CanBeLinked=&apos;0&apos; CanBeQuadrantPattern=&apos;0&apos; IsLinked=&apos;0&apos; IsQuadrantPattern=&apos;0&apos; OnlyOneSelection=&apos;1&apos; OverwriteHeadMode=&apos;0&apos; QuadrantPattern=&apos;0&apos; StartingQuadrant=&apos;1&apos; &gt;
		&lt;PipetteHeadMode Channels=&apos;0&apos; ColumnCount=&apos;12&apos; RowCount=&apos;1&apos; SubsetConfig=&apos;2&apos; SubsetType=&apos;2&apos; TipType=&apos;0&apos; /&gt;
		&lt;Wells &gt;
			&lt;Well Column=&apos;0&apos; Row=&apos;3&apos; /&gt;
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='BuiltIn::JavaScript' >
					...
					<TaskScript Name='TaskScript' Value='var mNumberTransfers = Math.ceil(mTransferVolume / MAX_VOLUME);' />
					<Parameters >
						<Parameter Category='Task Description' Name='Task number' Value='5' />
						<Parameter Category='Task Description' Name='Task description' Value='JavaScript' />
						<Parameter Category='Task Description' Name='Use default task description' Value='1' />
				...
				<Task Name='BuiltIn::Loop' >
					...
					<TaskScript Name='TaskScript' Value='' />
					<Parameters >
						<Parameter Category='' Name='Number of times to loop' TaskParameterScript='=mNumberTransfers;' Value='mTemp;' />
						<Parameter Category='' Name='Change tips every N times, N = ' Value='1' />
					</Parameters>
					<Variables />
				</Task>
				<Task Name='BuiltIn::JavaScript' >
					...
					<TaskScript Name='TaskScript' Value='var mAspPosition = [[bindRow,1]];
var mDispPosition = [[sepRow,1]];
var mGetTips = false;
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Aspirate' Task_Type='1' >
					...
					<TaskScript Name='TaskScript' Value='task.Wellselection = mAspPosition;
task.Volume = mTransferVolume / mNumberTransfers;
task.Liquidclass = mLiquidClass;
task.Distancefromwellbottom = mAspDistance;' />
					<Parameters >
						<Parameter Category='' Name='Location, plate' Value='BeadPlate' />
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Mix [Dual Height]' Task_Type='4096' >
					...
					<TaskScript Name='TaskScript' Value='var volumeToUse = (mTransferVolume / mNumberTransfers * 0.5);

task.Wellselection = mAspPosition;
task.Volume = volumeToUse;
task.Liquidclass = mLiquidClass;
task.Mixcycles = 3;
...
var mAspDistance = 1;
var mDispDistance = 1;
// the bead plate contains the volume for both spri clean ups
var mMixVolume = (0.8 * (beadVolume + 54) &gt; MAX_MIX_VOLUME) ? MAX_MIX_VOLUME : 0.8 * beadVolume;
...
' />
					<Parameters >
						...
						<Parameter Category='Properties' Name='Allow automatic tracking of tip usage' Value='0' />
						<Parameter Category='Properties' Name='Well selection' Value='&lt;?xml version=&apos;1.0&apos; encoding=&apos;ASCII&apos; ?&gt;
&lt;Velocity11 file=&apos;MetaData&apos; md5sum=&apos;50cb4d2dd210b638f1e7f3bd5eaa535e&apos; version=&apos;1.0&apos; &gt;
	&lt;WellSelection CanBe16QuadrantPattern=&apos;0&apos; CanBeLinked=&apos;0&apos; CanBeQuadrantPattern=&apos;0&apos; IsLinked=&apos;0&apos; IsQuadrantPattern=&apos;0&apos; OnlyOneSelection=&apos;1&apos; OverwriteHeadMode=&apos;0&apos; QuadrantPattern=&apos;0&apos; StartingQuadrant=&apos;1&apos; &gt;
		&lt;PipetteHeadMode Channels=&apos;0&apos; ColumnCount=&apos;12&apos; RowCount=&apos;1&apos; SubsetConfig=&apos;3&apos; SubsetType=&apos;2&apos; TipType=&apos;0&apos; /&gt;
		&lt;Wells &gt;
			&lt;Well Column=&apos;0&apos; Row=&apos;0&apos; /&gt;
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Dispense' Task_Type='2' >
					...
					<TaskScript Name='TaskScript' Value='
task.Wellselection = dispRows(rows, mDispPosition);
task.Volume = mTransferVolume / mNumberSteps;
task.Liquidclass = mLiquidClass;
task.Distancefromwellbottom = mDispDistance;
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Dispense' Task_Type='2' >
					...
					<TaskScript Name='TaskScript' Value='
task.Wellselection = mDispPosition;
task.Volume = sampleVolume+3;
task.Liquidclass = &quot;j_slow_large_vol&quot;;
task.Distancefromwellbottom = 5;
' />
					<Parameters >
						<Parameter Category='' Name='Location, plate' Value='BeadPlate' />
						<Parameter Category='' Name='Location, location' Value='&lt;auto-select&gt;' />
