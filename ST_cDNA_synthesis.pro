...
<Velocity11 file='Protocol_Data' md5sum='998577961e05ee53158210235765ad57' version='2.0' >
...
var protocolName = global.formProtocol || &quot;cDNA synthesis&quot;;

// Denaturation parameters
var sampleRow = global.settings.sampleRow || 3;
var sampleVolume = global.settings.sampleVolume || 12;
var cdnaSynthesisRow = global.settings.cdnaSynthesisRow || 3;
var primerDenatTime = global.settings.primerDenatTime || 5 * timeMod;
var primerDenatTemp = global.settings.primerDenatTemp || 65;

// cDNA synthsis parameters
var superscriptRow = global.settings.superscriptRow || 4;
var superscriptVolume = global.settings.superscriptVolume || 8;
var cdnaSynthesisTime = global.settings.cdnaSynthesisTime || 60 * timeMod; 
var cdnaSynthesisTemp = global.settings.cdnaSynthsesisTemp || 50;
...
global.currentStep = &quot;Starting cDNA synthesis step...&quot;;
...
print(&quot;This is global.timeMod, &quot; + global.timeMod);' />
				...
				<Task Name='Bravo::Set temperature - Position' >
					...
					<Parameters >
						...
						<Parameter Category='' Name='Turn off temperature' Value='0' />
						<Parameter Category='' Name='Temperature' TaskParameterScript='=primerDenatTemp;' Value='4' />
		...
		<Main_Processes >
			<Process >
				...
				<Task Name='Bravo::SubProcess' >
					...
					<TaskScript Name='TaskScript' Value='' />
					<Parameters >
						<Parameter Category='' Name='Sub-process name' Value='primerDenaturation' />
					...
					<Parameters >
						<Parameter Centrifuge='0' Name='SubProcess_Name' Pipettor='1' Value='primerDenaturation' />
					</Parameters>
				</Task>
				<Task Name='Bravo::SubProcess' >
					<Enable_Backup >0</Enable_Backup>
					...
					<TaskScript Name='TaskScript' Value='' />
					<Parameters >
						<Parameter Category='' Name='Sub-process name' Value='cdnaSynthesis' />
						<Parameter Category='Static labware configuration' Name='Display confirmation' Value='Don&apos;t display' />
						<Parameter Category='Static labware configuration' Name='1' Value='&lt;use default&gt;' />
						<Parameter Category='Static labware configuration' Name='2' Value='&lt;use default&gt;' />
						<Parameter Category='Static labware configuration' Name='3' Value='&lt;use default&gt;' />
					...
					<Parameters >
						<Parameter Centrifuge='0' Name='SubProcess_Name' Pipettor='1' Value='cdnaSynthesis' />
					</Parameters>
				</Task>
				<Task Name='Bravo::SubProcess' >
					<Enable_Backup >0</Enable_Backup>
			...
			<Pipette_Process Name='cdnaSynthesis' >
				<Minimized >0</Minimized>
...
global.currentStep = &quot;Starting cDNA synthesis&quot;;' />
					<Parameters >
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Aspirate' Task_Type='1' >
					...
					<TaskScript Name='TaskScript' Value='task.Wellselection = [[superscriptRow,1]];
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Dispense' Task_Type='2' >
					...
					<TaskScript Name='TaskScript' Value='task.Wellselection = [[cdnaSynthesisRow, 1]];
task.Volume = currentVolume + 1;
...
global.currentStep = &quot;cDNA synthesis incubation...&quot;;
' />
					<Parameters >
...
task.Reservationtime =cdnaSynthesisTime - elapsedTime;
' />
					<Parameters >
			...
			<Pipette_Process Name='dilution' >
				...
				<Task Name='Bravo::secondary::Set Head Mode' Task_Type='512' >
					...
					<TaskScript Name='TaskScript' Value='task.Headmode = headMode;
global.currentStep= &quot;cDNA synthesis finished...&quot;;' />
					<Parameters >
						<Parameter Category='' Name='Head mode' Value='&lt;?xml version=&apos;1.0&apos; encoding=&apos;ASCII&apos; ?&gt;
&lt;Velocity11 file=&apos;MetaData&apos; md5sum=&apos;6eb6437c4beafb3ee091dac7789eba57&apos; version=&apos;1.0&apos; &gt;
	&lt;PipetteHeadMode Channels=&apos;0&apos; ColumnCount=&apos;12&apos; RowCount=&apos;8&apos; SubsetConfig=&apos;1&apos; SubsetType=&apos;0&apos; TipType=&apos;0&apos; /&gt;
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Mix [Dual Height]' Task_Type='4096' >
					...
					<TaskScript Name='TaskScript' Value='currentVolume = currentVolume + dilutionVolume;
var mix_vol = 0.8 * (currentVolume);
if(mix_vol &gt; MAX_MIX_VOLUME) {
	mix_vol = MAX_MIX_VOLUME;
}
task.Volume = mix_vol;
task.Wellselection = [[superscriptRow,1]];
...
&lt;/Velocity11&gt;' />
			...
			<Pipette_Process Name='primerDenaturation' >
				<Minimized >0</Minimized>
				<Task Name='BuiltIn::Group Begin' >
					<Enable_Backup >0</Enable_Backup>
					<Task_Disabled >0</Task_Disabled>
				...
				<Task Name='Bravo::secondary::Set Head Mode' Task_Type='512' >
					...
					<TaskScript Name='TaskScript' Value='task.Headmode = headMode;
global.currentStep = &quot;Starting primer denaturation...&quot;;' />
					<Parameters >
						<Parameter Category='' Name='Head mode' Value='&lt;?xml version=&apos;1.0&apos; encoding=&apos;ASCII&apos; ?&gt;
&lt;Velocity11 file=&apos;MetaData&apos; md5sum=&apos;6eb6437c4beafb3ee091dac7789eba57&apos; version=&apos;1.0&apos; &gt;
	&lt;PipetteHeadMode Channels=&apos;0&apos; ColumnCount=&apos;12&apos; RowCount=&apos;8&apos; SubsetConfig=&apos;1&apos; SubsetType=&apos;0&apos; TipType=&apos;0&apos; /&gt;
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Mix [Dual Height]' Task_Type='4096' >
					...
					<TaskScript Name='TaskScript' Value='var currentVolume = sampleVolume;
var mix_vol = 0.6 * (currentVolume);
if(mix_vol &gt; MAX_MIX_VOLUME) {
	mix_vol = MAX_MIX_VOLUME;
}
task.Volume = mix_vol;
task.Wellselection = [[sampleRow,1]];
task.Aspiratedistance = 1;
task.Mixcycles = 3;
task.Liquidclass = &quot;j_slow_mixing&quot;;
' />
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='BuiltIn::Reserve Location' >
					...
					<Has_Breakpoint >0</Has_Breakpoint>
					<Advanced_Settings />
					<TaskScript Name='TaskScript' Value='global.currentStep = &quot;Denaturating sample and primer...&quot;;
task.Reservationtime = primerDenatTime;' />
					<Parameters >
						<Parameter Category='Task Description' Name='Task number' Value='9' />
						<Parameter Category='Task Description' Name='Task description' Value='Reserve Location' />
						<Parameter Category='Task Description' Name='Use default task description' Value='1' />
				...
				<Task Name='Bravo::secondary::Set temperature - Position' Task_Type='1024' >
					...
					<TaskScript Name='TaskScript' Value='task.Temperature = cdnaSynthesisTemp;
...
task.Distancefromwellbottom = 2;
task.Liquidclass = &quot;j_normal_medium_vol&quot;;
global.currentStep = &quot;Denaturation finished...&quot;;' />
					<Parameters >
						<Parameter Category='' Name='Location, plate' Value='EnzymePlate' />
						<Parameter Category='' Name='Location, location' Value='&lt;auto-select&gt;' />
						<Parameter Category='Volume' Name='Empty tips' Value='0' />
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Mix [Dual Height]' Task_Type='4096' >
					...
					<TaskScript Name='TaskScript' Value='var currentVolume = sampleVolume + superscriptVolume;
var mix_vol = 0.8 * (currentVolume);
if(mix_vol &gt; MAX_MIX_VOLUME) {
	mix_vol = MAX_MIX_VOLUME;
}
