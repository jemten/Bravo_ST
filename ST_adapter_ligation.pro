...
<Velocity11 file='Protocol_Data' md5sum='bb87d500c98b450ef5dbfd23c1999957' version='2.0' >
...
var protocolName = global.formProtocol || &quot;Adapter ligation&quot;;

// Denaturation parameters
var sampleRow = global.settings.sampleRow || 1;
var sampleVolume = global.settings.sampleVolume || 10.5;
var ligationRow = global.settings.ligationRow || 1;
var adapterDenatTime = global.settings.adapterDenatTime || 2 * timeMod;
var adapterDenatTemp = global.settings.adapterDenatTemp || 70;

// Adapter ligation parameters
var t4RnaLigaseRow = global.settings.t4RnaLigaseRow || 2;
var t4RnaLigaseVolume = global.settings.t4RnaLigaseVolume || 4.5;
var ligationTime = global.settings.ligationTime || 60 * timeMod; 
var ligationTemp = global.settings.ligationTemp || 25;

// dilution parameters
var dilutionRow = global.settings.dilutionRow || 4;
var dilutionVolume = global.settings.dilutionVolume || 15;

// Testing out status bar
global.currentStep = &quot;Starting adapter ligation step...&quot;;
...
print(&quot;This is global.timeMod, &quot; + global.timeMod);' />
				...
				<Task Name='Bravo::Set temperature - Position' >
					...
					<Parameters >
						...
						<Parameter Category='' Name='Temperature' TaskParameterScript='=adapterDenatTemp;' Value='4' />
				...
				<Task Name='Bravo::Set temperature - Position' >
					...
					<TaskScript Name='TaskScript' Value='global.currentStep = &quot;Cooling down the enzyme block to 4 C...&quot;;' />
					<Parameters >
		...
		<Main_Processes >
			<Process >
				...
				<Task Name='Bravo::SubProcess' >
					...
					<TaskScript Name='TaskScript' Value='' />
					<Parameters >
						<Parameter Category='' Name='Sub-process name' Value='adapterDenaturation' />
					...
					<Parameters >
						<Parameter Centrifuge='0' Name='SubProcess_Name' Pipettor='1' Value='adapterDenaturation' />
					</Parameters>
				</Task>
				<Task Name='Bravo::SubProcess' >
					<Enable_Backup >0</Enable_Backup>
					...
					<TaskScript Name='TaskScript' Value='' />
					<Parameters >
						<Parameter Category='' Name='Sub-process name' Value='adapterLigation' />
						<Parameter Category='Static labware configuration' Name='Display confirmation' Value='Don&apos;t display' />
						<Parameter Category='Static labware configuration' Name='1' Value='&lt;use default&gt;' />
						<Parameter Category='Static labware configuration' Name='2' Value='&lt;use default&gt;' />
						<Parameter Category='Static labware configuration' Name='3' Value='&lt;use default&gt;' />
					...
					<Parameters >
						<Parameter Centrifuge='0' Name='SubProcess_Name' Pipettor='1' Value='adapterLigation' />
					</Parameters>
				</Task>
				<Task Name='Bravo::SubProcess' >
					<Enable_Backup >0</Enable_Backup>
					...
					<TaskScript Name='TaskScript' Value='' />
					<Parameters >
						<Parameter Category='' Name='Sub-process name' Value='dilution' />
						<Parameter Category='Static labware configuration' Name='Display confirmation' Value='Don&apos;t display' />
						<Parameter Category='Static labware configuration' Name='1' Value='&lt;use default&gt;' />
						<Parameter Category='Static labware configuration' Name='2' Value='&lt;use default&gt;' />
						<Parameter Category='Static labware configuration' Name='3' Value='&lt;use default&gt;' />
					...
					<Parameters >
						<Parameter Centrifuge='0' Name='SubProcess_Name' Pipettor='1' Value='dilution' />
					</Parameters>
				</Task>
				<Plate_Parameters >
			...
			<Pipette_Process Name='adapterDenaturation' >
				<Minimized >0</Minimized>
...
global.currentStep = &quot;Starting adapter denaturation...&quot;;' />
					<Parameters >
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Dispense' Task_Type='2' >
					...
					<TaskScript Name='TaskScript' Value='task.Wellselection = [[ligationRow,1]];
task.Volume = sampleVolume + 1;
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='BuiltIn::Reserve Location' >
					...
					<Has_Breakpoint >0</Has_Breakpoint>
					<Advanced_Settings />
					<TaskScript Name='TaskScript' Value='global.currentStep = &quot;Denaturating adapter...&quot;;
task.Reservationtime = adapterDenatTime;' />
					<Parameters >
				...
				<Task Name='Bravo::secondary::Set temperature - Position' Task_Type='1024' >
					...
					<TaskScript Name='TaskScript' Value='task.Temperature = ligationTemp;
...
' />
					<Parameters >
						...
						<Parameter Category='' Name='Wait' Value='' />
						<Parameter Category='' Name='Temperature Tolerance' Value='' />
						<Parameter Category='' Name='Timeout' Value='' />
						<Parameter Category='' Name='Allow concurrent operation' Value='0' />
...
task.Liquidclass = &quot;j_normal_large_vol&quot;;
task.Volume = PRE_ASP_SMALL;
global.currentStep = &quot;Adapter denaturated...&quot;;' />
					<Parameters >
						<Parameter Category='' Name='Location, plate' Value='ReactionPlate' />
						<Parameter Category='' Name='Location, location' Value='&lt;auto-select&gt;' />
						<Parameter Category='Volume' Name='Volume' Value='' />
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Dispense' Task_Type='2' >
					...
					<TaskScript Name='TaskScript' Value='task.Wellselection = [[t4RnaLigaseRow,1]];
task.Volume = sampleVolume + 1;
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Mix [Dual Height]' Task_Type='4096' >
					...
					<TaskScript Name='TaskScript' Value='var currentVolume = sampleVolume + t4RnaLigaseVolume;
var mix_vol = 0.8 * (currentVolume);
if(mix_vol &gt; MAX_MIX_VOLUME) {
	mix_vol = MAX_MIX_VOLUME;
}
task.Volume = mix_vol;
task.Wellselection = [[t4RnaLigaseRow,1]];
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Set temperature - Position' Task_Type='1024' >
					...
					<TaskScript Name='TaskScript' Value='task.Temperature = ligationTemp; 
task.TemperatureTolerance = 1;
task.Timeout = 15;
global.currentStep = &quot;Waiting for reaction plate to cool...&quot;;' />
					<Parameters >
						<Parameter Category='' Name='Location' Value='6' />
						<Parameter Category='' Name='Turn off temperature' Value='0' />
						<Parameter Category='' Name='Temperature' Value='' />
...
&lt;/Velocity11&gt;' />
			...
			<Pipette_Process Name='adapterLigation' >
				<Minimized >0</Minimized>
				<Task Name='BuiltIn::Group Begin' >
					<Enable_Backup >0</Enable_Backup>
					<Task_Disabled >0</Task_Disabled>
				...
				<Task Name='Bravo::secondary::Set Head Mode' Task_Type='512' >
					...
					<TaskScript Name='TaskScript' Value='task.Headmode = headMode;
global.CurrentStep = &quot;Starting adapter ligation...&quot;;' />
					<Parameters >
						<Parameter Category='' Name='Head mode' Value='&lt;?xml version=&apos;1.0&apos; encoding=&apos;ASCII&apos; ?&gt;
&lt;Velocity11 file=&apos;MetaData&apos; md5sum=&apos;6eb6437c4beafb3ee091dac7789eba57&apos; version=&apos;1.0&apos; &gt;
	&lt;PipetteHeadMode Channels=&apos;0&apos; ColumnCount=&apos;12&apos; RowCount=&apos;8&apos; SubsetConfig=&apos;1&apos; SubsetType=&apos;0&apos; TipType=&apos;0&apos; /&gt;
...
global.currentStep = &quot;Ligating adapter...&quot;;' />
					<Parameters >
						<Parameter Category='Task Description' Name='Task number' Value='7' />
						<Parameter Category='Task Description' Name='Task description' Value='JavaScript' />
						<Parameter Category='Task Description' Name='Use default task description' Value='1' />
...
task.Reservationtime =ligationTime - elapsedTime;
' />
					<Parameters >
						<Parameter Category='Task Description' Name='Task number' Value='15' />
						<Parameter Category='Task Description' Name='Task description' Value='Reserve Location' />
			...
			<Pipette_Process Name='dilution' >
				...
				<Task Name='Bravo::secondary::Set Head Mode' Task_Type='512' >
					...
					<TaskScript Name='TaskScript' Value='task.Headmode = headMode;
global.currentStep = &quot;Adapter ligation finished...&quot;;' />
					<Parameters >
						<Parameter Category='' Name='Head mode' Value='&lt;?xml version=&apos;1.0&apos; encoding=&apos;ASCII&apos; ?&gt;
&lt;Velocity11 file=&apos;MetaData&apos; md5sum=&apos;6eb6437c4beafb3ee091dac7789eba57&apos; version=&apos;1.0&apos; &gt;
	&lt;PipetteHeadMode Channels=&apos;0&apos; ColumnCount=&apos;12&apos; RowCount=&apos;8&apos; SubsetConfig=&apos;1&apos; SubsetType=&apos;0&apos; TipType=&apos;0&apos; /&gt;
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Aspirate' Task_Type='1' >
					...
					<TaskScript Name='TaskScript' Value='task.Wellselection = [[dilutionRow, 1]];
task.Volume = PRE_ASP_MEDIUM;
task.Distancefromwellbottom = 50;
task.Liquidclass = &quot;j_normal_small_vol&quot;;
' />
...
task.Liquidclass = &quot;j_normal_low_vol&quot;;
task.Distancefromwellbottom = 1;' />
					<Parameters >
						<Parameter Category='' Name='Location, plate' Value='BeadPlate' />
						<Parameter Category='' Name='Location, location' Value='&lt;auto-select&gt;' />
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Dispense' Task_Type='2' >
					...
					<TaskScript Name='TaskScript' Value='task.Wellselection = [[t4RnaLigaseRow,1]];
task.Volume = currentVolume + preWetVolume + 2;
task.Distancefromwellbottom = 1; 
task.Liquidclass = &quot;j_normal_medium_vol&quot;;' />
					<Parameters >
						<Parameter Category='' Name='Location, plate' Value='EnzymePlate' />
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Mix [Dual Height]' Task_Type='4096' >
					...
					<TaskScript Name='TaskScript' Value='var currentVolume = currentVolume + dilutionVolume;
var mix_vol = 0.8 * (currentVolume);
if(mix_vol &gt; MAX_MIX_VOLUME) {
	mix_vol = MAX_MIX_VOLUME;
}
