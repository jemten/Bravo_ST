...
<Velocity11 file='Protocol_Data' md5sum='2a4ab4138a65b4454ca47f7bcd72a8d9' version='2.0' >
...
global.currentStep = &quot;Rearranging deck...&quot;;' />
					<Parameters >
				...
				<Task Name='Bravo::Set temperature - Position' >
					...
					<TaskScript Name='TaskScript' Value='task.Temperature = enzymeTemp;
task.Wait = false;
...
' />
		...
		<Main_Processes >
			<Process >
				...
				<Task Name='BuiltIn::Wait For' Waitfor='TipBox1' >
					<Enable_Backup >0</Enable_Backup>
					<Task_Disabled >0</Task_Disabled>
					<Task_Skipped >0</Task_Skipped>
					<Has_Breakpoint >0</Has_Breakpoint>
			...
			<Process >
				...
				<Task Name='BuiltIn::Wait For' Waitfor='BeadPlate' >
					<Enable_Backup >0</Enable_Backup>
					<Task_Disabled >0</Task_Disabled>
					<Task_Skipped >0</Task_Skipped>
					<Has_Breakpoint >0</Has_Breakpoint>
			...
			<Process >
				...
				<Task Name='BuiltIn::Signal' >
					...
					<TaskScript Name='TaskScript' Value='' />
					<Waitfors_To_Signal >
						<Waitfor Name='WastePlate' />
					</Waitfors_To_Signal>
				</Task>
				<Task Name='BuiltIn::Wait For' Waitfor='ReactionPlate' >
					<Enable_Backup >0</Enable_Backup>
					<Task_Disabled >0</Task_Disabled>
					<Task_Skipped >0</Task_Skipped>
					<Has_Breakpoint >0</Has_Breakpoint>
			...
			<Process >
				...
				<Task Name='BuiltIn::Wait For' Waitfor='EmptyTipBox' >
					<Enable_Backup >0</Enable_Backup>
					<Task_Disabled >1</Task_Disabled>
					<Task_Skipped >0</Task_Skipped>
					<Has_Breakpoint >0</Has_Breakpoint>
			...
			<Process >
				...
				<Task Name='BuiltIn::Wait For' Waitfor='WastePlate' >
					<Enable_Backup >0</Enable_Backup>
					<Task_Disabled >0</Task_Disabled>
					<Task_Skipped >0</Task_Skipped>
					<Has_Breakpoint >0</Has_Breakpoint>
				...
				<Task Name='BuiltIn::Signal' >
					...
					<TaskScript Name='TaskScript' Value='' />
					<Waitfors_To_Signal >
						<Waitfor Name='TipBox1' />
						<Waitfor Name='BeadPlate' />
						<Waitfor Name='ReactionPlate' />
					</Waitfors_To_Signal>
				</Task>
				<Plate_Parameters >
		...
		<Cleanup_Processes >
			<Process >
				...
				<Task Name='BuiltIn::JavaScript' >
					...
					<TaskScript Name='TaskScript' Value='print(&quot;Finished shuffling plates around&quot;);' />
					<Parameters >
						<Parameter Category='Task Description' Name='Task number' Value='1' />
						<Parameter Category='Task Description' Name='Task description' Value='JavaScript' />
						<Parameter Category='Task Description' Name='Use default task description' Value='1' />
